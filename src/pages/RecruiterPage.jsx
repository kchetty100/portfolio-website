...
import { FaPlay, FaLinkedin, FaUser, FaCode, FaProjectDiagram, FaCertificate, FaBriefcase, FaThumbsUp, FaEnvelope, FaMusic, FaBook, FaBlog, FaPhone, FaArrowLeft } from 'react-icons/fa';
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-8">
              <button 
                onClick={onBack} 
                className="text-2xl font-bold text-netflixRed hover:text-red-400 transition-colors cursor-pointer flex items-center space-x-2"
              >
                <FaArrowLeft />
                <span>KEEGAN CHETTY</span>
              </button>
              <div className="hidden md:flex space-x-6">
                <button className="text-white font-medium">Home</button>
                <button className="text-gray-300 hover:text-white transition-colors">Professional</button>
